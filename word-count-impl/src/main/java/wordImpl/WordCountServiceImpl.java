...
public class WordCountServiceImpl implements WordCountService {
    ...
    @Inject
    public WordCountServiceImpl(PersistentEntityRegistry persistentEntityRegistry, ReadSide readSide, CassandraSession session) {
    ...
    public ServiceCall<NotUsed, String> getCount(String word) {
        ...
        return request -> persistentEntityRegistry.refFor(WordEntity.class, word).ask(new WordCommand.GetCount(word));
    }
